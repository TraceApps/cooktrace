 ...
 *   .drag-handle          reorder handles (shopping list)
 *   [data-no-pull-sync]   anything else draggable: the Trace button, recipe
 *                         ingredient and step handles, cookbook cards while
