  ...
  <div use:portal class="tp-backdrop" role="dialog" aria-modal="true" use:closeOnBack={() => open = false}
    ...
    <div class="tp-sheet" on:click|stopPropagation on:keydown={() => {}}>
      ...
      <div class="tp-columns">
        <div class="tp-col">
          <div class="tp-col-label">{$_('time_picker_ct.hour')}</div>
        ...
        <div class="tp-col">
          <div class="tp-col-label">{$_('time_picker_ct.minute')}</div>
      ...
      <div class="tp-actions">
        <button class="btn btn-ghost" on:click={() => open = false}>{$_('time_picker_ct.cancel')}</button>
        <button class="btn btn-primary" on:click={_confirm}>{$_('time_picker_ct.set_time')}</button>
      </div>
    </div>
  </div>
{/if}
